...
dataset = load_dataset("json", data_files={"train": "launcher_dataset.jsonl"}, split="train")
...
model.save_pretrained_gguf("fast_launcher_model", tokenizer, quantization_method = "q4_k_m")
